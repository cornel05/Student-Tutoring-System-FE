    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        toast.success('Declaration submitted successfully!', {
          description: 'Your academic advisor and faculty office have been notified.'
        });
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <div className="grid grid-cols-2 gap-3">
                    <div className="p-3 bg-white border border-blue-200 rounded-lg">
                      ...
                      <p className="text-sm text-gray-900">{declaration.major}</p>
                    </div>
                    <div className="p-3 bg-white border border-blue-200 rounded-lg">
                      <p className="text-xs text-gray-600 mb-1">Minor</p>
                      <p className="text-sm text-gray-900">{declaration.minor || 'None'}</p>
                    </div>
                  </div>

                  {declaration.additionalCourses.length > 0 && (
                    <div className="p-3 bg-white border border-blue-200 rounded-lg">
                      <p className="text-xs text-gray-600 mb-2">Additional Courses</p>
                  ...
                  <div className="space-y-3">
                    {declaration.supportNeeds.scholarship && (
                      <div className="p-3 bg-white border border-orange-200 rounded-lg">
                        <div className="flex items-start gap-2 mb-2">
                          ...
                          <p className="text-sm text-gray-900">Scholarship Assistance</p>
                        </div>
                        {declaration.scholarshipDetails && (
                          <p className="text-xs text-gray-600 ml-6">{declaration.scholarshipDetails}</p>
                        )}
                      </div>
                    )}
                    ...
                    {declaration.supportNeeds.academicHelp && (
                      <div className="p-3 bg-white border border-orange-200 rounded-lg">
                        <div className="flex items-start gap-2 mb-2">
                          <CheckCircle2 className="w-4 h-4 text-orange-600 mt-0.5" />
                          <p className="text-sm text-gray-900">Academic Help (Tutoring, Study Groups)</p>
                        </div>
                        {declaration.academicHelpDetails && (
                          <p className="text-xs text-gray-600 ml-6">{declaration.academicHelpDetails}</p>
                        )}
                      </div>
                    )}
                    ...
                    {declaration.supportNeeds.advising && (
                      <div className="p-3 bg-white border border-orange-200 rounded-lg">
                        <div className="flex items-start gap-2 mb-2">
                          <CheckCircle2 className="w-4 h-4 text-orange-600 mt-0.5" />
                          <p className="text-sm text-gray-900">Academic Advising</p>
                        </div>
                        {declaration.advisingDetails && (
                          <p className="text-xs text-gray-600 ml-6">{declaration.advisingDetails}</p>
                        )}
                      </div>
                    )}
                    ...
                    {declaration.supportNeeds.mentalHealth && (
                      <div className="p-3 bg-white border border-orange-200 rounded-lg">
                        <div className="flex items-start gap-2">
                          <CheckCircle2 className="w-4 h-4 text-orange-600 mt-0.5" />
                          <p className="text-sm text-gray-900">Mental Health & Wellness Support</p>
                        </div>
                      </div>
                    )}
                    ...
                    {declaration.supportNeeds.careerGuidance && (
                      <div className="p-3 bg-white border border-orange-200 rounded-lg">
                        <div className="flex items-start gap-2">
                          <CheckCircle2 className="w-4 h-4 text-orange-600 mt-0.5" />
                          <p className="text-sm text-gray-900">Career Guidance & Internship Support</p>
                        </div>
                      </div>
                    )}
                  </div>
              ...
              {declaration.additionalNotes && (
                <div className="p-3 bg-white border border-blue-200 rounded-lg">
                  ...
                  <p className="text-sm text-gray-900">{declaration.additionalNotes}</p>
                </div>
              )}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-blue-800 text-sm mb-3">
                      Please complete your enrollment declaration and declare any support needs for this semester.
                    </p>
                    <ul className="text-sm text-blue-700 space-y-1 mb-4">
                      <li>• Declare your major, minor, and additional courses</li>
      ...
      <Dialog open={showDeclarationDialog} onOpenChange={setShowDeclarationDialog}>
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Complete your academic program details and declare any support needs for this semester.
              This information will be validated with HCMUT_DATACORE.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-6 py-4">
            ...
            <div className="space-y-4">
              <h3 className="text-gray-900 border-b pb-2">Academic Program Details</h3>
              ...
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-1">Your major is set by your enrollment and cannot be changed here</p>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setDeclaration({ ...declaration, minor: e.target.value })}
              ...
              <div>
                <Label className="mb-2 block">Additional Courses (Optional)</Label>
                <div className="grid grid-cols-2 gap-3">
                    ...
                    <div key={course} className="flex items-center space-x-2">
                      <label className="flex items-center cursor-pointer">
                        <input
                          type="checkbox"
                          id={course}
                          checked={declaration.additionalCourses.includes(course)}
            ...
            <div className="space-y-4">
              <h3 className="text-gray-900 border-b pb-2">Support Needs Declaration</h3>
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                  <label className="flex items-center cursor-pointer pt-0.5">
                    <input
                      ...
                      onChange={(e) => 
                        setDeclaration({
                          ...declaration,
                          supportNeeds: { ...declaration.supportNeeds, scholarship: e.target.checked }
                        })
                      }
                      className="dark:border-white-400/20 dark:scale-100 transition-all duration-500 ease-in-out dark:hover:scale-110 dark:checked:scale-100 w-5 h-5 border-gray-300 rounded cursor-pointer"
                    />
                  ...
                  <div className="flex-1">
                    <label htmlFor="scholarship" className="text-sm text-gray-900 cursor-pointer block mb-1">
                    ...
                    {declaration.supportNeeds.scholarship && (
                      <Textarea
                        ...
                        onChange={(e) => setDeclaration({ ...declaration, scholarshipDetails: e.target.value })}
                ...
                <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                  <label className="flex items-center cursor-pointer pt-0.5">
                    <input
                      ...
                      onChange={(e) => 
                        setDeclaration({
                          ...declaration,
                          supportNeeds: { ...declaration.supportNeeds, academicHelp: e.target.checked }
                        })
                      }
                      className="dark:border-white-400/20 dark:scale-100 transition-all duration-500 ease-in-out dark:hover:scale-110 dark:checked:scale-100 w-5 h-5 border-gray-300 rounded cursor-pointer"
                    />
                  ...
                  <div className="flex-1">
                    <label htmlFor="academicHelp" className="text-sm text-gray-900 cursor-pointer block mb-1">
                    ...
                    {declaration.supportNeeds.academicHelp && (
                      <Textarea
                        ...
                        onChange={(e) => setDeclaration({ ...declaration, academicHelpDetails: e.target.value })}
                        className="mt-2 text-sm"
                        rows={2}
                      />
                    )}
                ...
                <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                  <label className="flex items-center cursor-pointer pt-0.5">
                    <input
                      ...
                      onChange={(e) => 
                        setDeclaration({
                          ...declaration,
                          supportNeeds: { ...declaration.supportNeeds, advising: e.target.checked }
                        })
                      }
                      className="dark:border-white-400/20 dark:scale-100 transition-all duration-500 ease-in-out dark:hover:scale-110 dark:checked:scale-100 w-5 h-5 border-gray-300 rounded cursor-pointer"
                    />
                  ...
                  <div className="flex-1">
                    <label htmlFor="advising" className="text-sm text-gray-900 cursor-pointer block mb-1">
                      Academic Advising
                    </label>
                    {declaration.supportNeeds.advising && (
                      <Textarea
                        ...
                        onChange={(e) => setDeclaration({ ...declaration, advisingDetails: e.target.value })}
                        className="mt-2 text-sm"
                        rows={2}
                      />
                    )}
                  ...
                  <label className="flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) => 
                        setDeclaration({
                          ...declaration,
                          supportNeeds: { ...declaration.supportNeeds, mentalHealth: e.target.checked }
                        })
                      }
                      className="dark:border-white-400/20 dark:scale-100 transition-all duration-500 ease-in-out dark:hover:scale-110 dark:checked:scale-100 w-5 h-5 border-gray-300 rounded cursor-pointer"
                    />
                  </label>
                  <label htmlFor="mentalHealth" className="text-sm text-gray-900 cursor-pointer">
                  ...
                  <label className="flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) => 
                        setDeclaration({
                          ...declaration,
                          supportNeeds: { ...declaration.supportNeeds, careerGuidance: e.target.checked }
                        })
                      }
                      className="dark:border-white-400/20 dark:scale-100 transition-all duration-500 ease-in-out dark:hover:scale-110 dark:checked:scale-100 w-5 h-5 border-gray-300 rounded cursor-pointer"
                    />
                  </label>
                  <label htmlFor="careerGuidance" className="text-sm text-gray-900 cursor-pointer">
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) => setDeclaration({ ...declaration, additionalNotes: e.target.value })}
                  className="mt-2"
                  rows={3}
                />
              </div>
            ...
            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <p className="text-sm text-blue-800">
                <strong>Note:</strong> Your declaration will be validated with HCMUT_DATACORE and your academic advisor 
                and faculty office will be notified. Support services will reach out to you based on your declared needs.
              </p>
            </div>
          </div>
