...
export function MySessions() {
  ...
  const handleCancelRequest = () => {
    ...
    setSessions(prev =>
      prev.map(s =>
        s.id === cancellingSession ? { ...s, status: "cancelled" as const } : s
      )
    );
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-gray-600">
          View and manage your active tutoring sessions
        </p>
      </div>
          ...
          <Card>
            <CardContent className="p-12 text-center">
              ...
              <p className="text-gray-500 mb-4">
                You don't have any active tutoring sessions yet
              </p>
                      ...
                      <div className="grid grid-cols-3 gap-4 text-sm">
                        <div>
                          ...
                          <span className="ml-2 text-gray-900">
                            {session.meetings.length}
                          </span>
                        </div>
                        <div>
                          <span className="text-gray-600">Attended:</span>
                          <span className="ml-2 text-gray-900">
                            {session.meetings.filter(m => m.attended).length}
                          </span>
                        </div>
                        <div>
      ...
      >
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Please provide a reason for cancelling this session. This helps us
              improve our service.
            </DialogDescription>
          </DialogHeader>
      ...
      >
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Share your experience with this tutoring session. Your feedback
              helps improve the quality of tutoring services.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Your feedback will help other students and improve the tutoring
                system
              </p>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-3 mt-3">
                ...
                >
                  <ThumbsUp
                    className={`w-6 h-6 mx-auto mb-2 ${recommendTutor === true ? "text-green-600" : "text-gray-400"}`}
                  />
                ...
                >
                  <XCircle
                    className={`w-6 h-6 mx-auto mb-2 ${recommendTutor === false ? "text-red-600" : "text-gray-400"}`}
                  />
