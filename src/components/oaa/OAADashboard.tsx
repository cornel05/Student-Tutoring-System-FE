    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-gray-600">
          Overview reports for resource allocation and strategic planning
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card className="border-pink-200 bg-white">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-pink-600 text-sm mb-1 font-medium">
                  Student Satisfaction
                </p>
                <p className="text-4xl font-bold text-gray-900">
                  {reports.satisfaction.score}/5.0
                </p>
                <p className="text-xs text-gray-600 mt-2">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 border rounded-lg">
                ...
                <p className="text-2xl text-gray-900 mb-1">
                  {reports.utilization.totalParticipants}
                </p>
              ...
              <div className="p-4 border rounded-lg">
                ...
                <p className="text-2xl text-gray-900 mb-1">
                  {reports.utilization.activeTutors}
                </p>
                <p className="text-xs text-gray-500">
              ...
              <div className="p-4 border rounded-lg">
                ...
                <p className="text-2xl text-gray-900 mb-1">
                  {reports.utilization.sessionsCompleted}
                </p>
              ...
              <div className="p-4 border rounded-lg">
                <p className="text-sm text-gray-600 mb-2">
                  Avg Hours per Student
                </p>
                <p className="text-2xl text-gray-900 mb-1">
                  {reports.utilization.avgHoursPerStudent}
                </p>
            ...
            <div className="p-4 bg-indigo-50 rounded-lg">
              ...
              <p className="text-xs text-indigo-700">
                Current utilization rate of {reports.utilization.rate}%
                indicates healthy program adoption. Consider expanding tutor
                capacity by 15% to meet growing demand in Computer Science and
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-pink-50 rounded-lg">
              ...
              <ul className="space-y-1 text-xs text-pink-700">
                <li>
                  • 92% of students report improved understanding of course
                  material
                </li>
                <li>• 88% would recommend the tutoring program to peers</li>
                <li>
                  • Most valued aspects: Flexible scheduling (87%), Peer
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 border rounded-lg">
                ...
                <p className="text-2xl text-gray-900 mb-1">
                  +{reports.outcomes.passRateIncrease}%
                </p>
                <p className="text-xs text-gray-500">
              ...
              <div className="p-4 border rounded-lg">
                <p className="text-sm text-gray-600 mb-2">
                  Grade Point Increase
                </p>
                <p className="text-2xl text-gray-900 mb-1">
                  +{reports.outcomes.gradePointIncrease}
                </p>
              ...
              <div className="p-4 border rounded-lg">
                ...
                <p className="text-2xl text-gray-900 mb-1">
                  {reports.outcomes.retentionRate}%
                </p>
                <p className="text-xs text-gray-500">
              ...
              <div className="p-4 border rounded-lg">
                ...
                <p className="text-2xl text-gray-900 mb-1">
                  {reports.outcomes.successStories}
                </p>
                <p className="text-xs text-gray-500">Grade F to C+ or better</p>
              </div>
            </div>
            ...
            <div className="p-4 bg-teal-50 rounded-lg">
              ...
              <ul className="space-y-1 text-xs text-teal-700">
                <li>
                  • Allocate additional budget: Estimated ROI of 3.2x based on
                  retention improvements
                </li>
                <li>
                  • Expand program to include group tutoring sessions (pilot
                  showed +15% engagement)
                </li>
                <li>
                  • Integrate with early warning systems to proactively identify
                  at-risk students
                </li>
              </ul>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 border rounded-lg bg-blue-50">
              ...
              <p className="text-2xl text-blue-700 mb-1">
                {reports.budget.current}
              </p>
              <p className="text-xs text-blue-600">Allocated budget</p>
            </div>
            ...
            <div className="p-4 border rounded-lg bg-green-50">
              ...
              <p className="text-2xl text-green-700 mb-1">
                {reports.budget.recommended}
              </p>
              <p className="text-xs text-green-600">For next semester</p>
            </div>

            <div className="p-4 border rounded-lg bg-purple-50">
              <p className="text-sm text-purple-900 mb-2">Expected Impact</p>
              <p className="text-2xl text-purple-700 mb-1">
                +{reports.budget.expectedGrowth}%
              </p>
